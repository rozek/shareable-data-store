...
import { SDS_Entry, SDS_Item, SDS_Link, SDS_DataStore as SDS_StoreBase, SDS_DataStoreOptions } from '@rozek/sds-core';
import type { SDS_SyncCursor, ChangeOrigin, ChangeHandler } from '@rozek/sds-core';
export type { ChangeOrigin, ChangeHandler, SDS_DataStoreOptions };
export declare class SDS_DataStore extends SDS_StoreBase {
    #private;
...
//# sourceMappingURL=SDS_DataStore.d.ts.map