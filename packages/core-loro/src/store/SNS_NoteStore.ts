/*******************************************************************************
*                                                                              *
*       SNS_NoteStore - wraps a Loro CRDT Doc without exposing it              *
*                                                                              *
*******************************************************************************/
...
//----------------------------------------------------------------------------//
  ...
  private constructor (Doc:Loro, Options?:SNS_NoteStoreOptions) {
    this.#doc              = Doc
...
/**** currentCursor — get current version vector as sync cursor ****/
  ...
  get currentCursor ():SNS_SyncCursor {
    // Encode Loro VersionVector as bytes for use as SNS_SyncCursor
