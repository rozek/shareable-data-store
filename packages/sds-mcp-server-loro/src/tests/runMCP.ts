...
// spawns the built sds-mcp-server-loro binary via StdioClientTransport and
// wraps the MCP Client API in a simpler interface for use in integration tests
...
const ServerPath = path.resolve(__dirname, '../../dist/sds-mcp-server-loro.js')
