# Test Cases — `@rozek/sds-sidecar-jj`

Tests spawn `dist/sds-sidecar-jj.js` as a child process and inspect exit code, stdout, and stderr.
...
|---|---|---|
| SC-01 | `--help` | exits with code 0; stdout contains "Usage:" and "sds-sidecar-jj" |
